...
def calculate_partial_digest(username, realm, password):
    ...
    return md5.md5(digest.encode("utf-8")).hexdigest()
...
def build_authorization_request(
    ...
    if password and request_digest:
        ...
        request_digest = calculate_request_digest(
            method,
            partial_digest,
            uri=uri,
            nonce=nonce,
...
def parse_digest_challenge(authentication_header):
    ...
    parts = parse_parts(
        authentication_header[7:], defaults={"algorithm": "MD5", "stale": "false"}
    )
